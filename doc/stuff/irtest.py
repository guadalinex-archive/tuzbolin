...
#                                                                              #
#   Python script that outpust to a window the points reported by the wiimote  #
...
def cback(messages):
    ...
    global drawing, last_point, runing, last_distance, last_ok_time, dist_min, dist_max
    for msg in messages:
