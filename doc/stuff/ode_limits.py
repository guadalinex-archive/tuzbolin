...
################################################################################
#                                                                              #
#   Pyode hinged joint limits test                                             #
...
if __name__ == "__main__" :
    ...
    join.setParam(ode.ParamFMax, 100000)
    ...
    while running:
            ...
            if e.type==KEYDOWN:
                if e.key==K_ESCAPE:
                    ...
                    if ulimit:
                        ...
                        join.setParam(ode.ParamHiStop, math.pi * 0.25)
                        ulimit = 1
                elif e.key == K_LEFT:
                    if llimit:
                        ...
                        join.setParam(ode.ParamLoStop, -math.pi * 0.25)                    
                        llimit = 1
        ...
        hp = math.pi / 2.0
        if ulimit:
            ulx, uly = (100 * math.cos(math.pi * -0.25 + hp),
                        100 * math.sin(math.pi * -0.25 + hp))
            pygame.draw.line(display, (0, 0, 128), (ulx + 320, uly + 240), (320, 240), 3)
        if llimit:
            llx, lly = (100 * math.cos(math.pi * 0.25 + 2 * hp),
                        100 * math.sin(math.pi * 0.25 + 2 * hp))
